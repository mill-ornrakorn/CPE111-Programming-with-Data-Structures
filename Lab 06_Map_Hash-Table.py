...
with open('Data/student.csv','r',encoding="utf-8-sig") as f:
    reader = csv.reader(f)
...
print(STD["62070505213"]) # PHAKCHIRA TRITHIRAROT
print(STDChain["62070505234"]) # KATIYA KENPHAENG
print(STDChain["62070505238"]) # ONRAKORN MEKCHAIPORN
