...
class DDeque:
    ...
    def AddFirst(self,item):
        # เรียกใช้ def insert_between มาใช้ โดยรับ item มา
        # ซึ่งจะทำการ insert ค่าเข้าไปไว้ข้าง ๆ head [ระหว่าง header และตัวถัดมาของ header] 
        self.insert_between(item, self._header , self._header._next )


    def AddRear(self,item):
        # เรียกใช้def insert_between  มาใช้ โดยรับ item มา
        # ซึ่งจะทำการ insert ค่าเข้าไปไว้ก่อน tail [ระหว่างตัวถัดมาของ trailer และ trailer]
        self.insert_between(item, self._trailer._prev , self._trailer )
        
    def DeleteFirst(self):
        assert not self.isEmpty(),"Deque is empty"
        
        # เรียกใช้ def delete_node โดยจะลบตัวที่อยู่ข้าง ๆ header
    ...
    def DeleteRear(self):
        ...
        # เรียกใช้ฟังก์ชั่น def delete_node โดยจะลบตัวที่อยู่ก่อน trailer
